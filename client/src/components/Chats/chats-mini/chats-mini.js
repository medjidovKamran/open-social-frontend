...
function ChatsMini() {
	...
	return (
		<div className={s.miniDialogs}>
			{!openChat ? (
				<Button variant="outline-light" className={s.chatButton} onClick={handleOpenChat}>
					Chats
				</Button>
			) : (
				<div>
					<Button variant="outline-light" className={s.chatButton} onClick={handleCloseChat}>
						Chats
					</Button>
					<div
						ref={miniChat}
					...
					>
						{openDialogs && (
							<div className={s.buttonBackToChatUsers} onClick={handleCloseDialogs}>
								<ArrowBackIosIcon />
							</div>
						)}
						<div className={s.buttonCloseWindowMiniChat} onClick={handleCloseChat}>
							<CloseIcon />
						</div>
						<div>
							<ChatSearchPanel />
						</div>
						<div onClick={handleOpenDialogs}>{/*  <ChatsBlockUsers /> */}</div>
