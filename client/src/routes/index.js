...
const routes = [
	{
		...
		children: [
			{
				load: () => import(/* webpackChunkName: 'login' */ '../components/login'),
				path: '/login'
			}
		],
		path: ''
	...
	},
	{
		...
		children: [
			...
			{
				load: () => import(/* webpackChunkName: 'profile' */ '../components/profile'),
				path: '/profile:id'
			},
			{
				load: () => import(/* webpackChunkName: 'about' */ '../components/about'),
				path: '/about'
			},
			{
				load: () => import(/* webpackChunkName: 'chats' */ '../components/Chats'),
				path: '/chats'
			},
			{
				load: () => import(/* webpackChunkName: 'edit-profile' */ '../components/EditProfile'),
				path: '/edit-profile'
			},
			{
				load: () => import(/* webpackChunkName: 'users' */ '../components/UsersPage'),
				path: '/users'
			},
			{
				load: () => import(/* webpackChunkName: 'not-found' */ '../components/not-found'),
				path: '(.+)'
			}
		],
		path: '',
